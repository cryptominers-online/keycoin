...
uint256 hashGenesisBlock("0x2218e3cafc9a33fddd2df69671661f6b79999ff3e4996f7ddd9dfd1647b241bb");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // KeyCoin: starting difficulty is 1 / 2^12
...
{
    // KeyCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // KeyCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // KeyCoin: 3.5 days
static const int64 nTargetSpacing = 120; // KeyCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // KeyCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // KeyCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // KeyCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf86ce5fce09c0a73cc596a37d40027b24497f765906ac3410bb5c94c3e41af4e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "The Democrats Screwed Up 11 13 2016";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("8d29afc31397ef89b0ba490e460635c5d54737f8d881df5de744dfbe50d38d6034a045371f497edaf4f2afd7ca3989ca17854e37f7b1860c5c2737cb66f2d9d530") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1479056157;
        block.nBits    = 504365644;
        block.nNonce   = 2182766450;

        if (fTestNet)
        {
            block.nTime    = 1479056157;
            block.nNonce   = 2601521633;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8010dfa73a3f071662cbd14663f5fa23f8f7618e782ea5e8a935e18e94d2d200"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // KeyCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("KeyCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("KeyCoinMiner : ProcessBlock, block not accepted");
    }
